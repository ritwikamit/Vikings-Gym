    ...
    prisma.user.create({
      data: {
        ...
        trainer: {
          create: {
            experience: 5,
            certifications: ["ACE Certified", "NASM-CPT", "Sports Nutrition"].join(","),
            specialization: ["Strength & Conditioning", "Bodybuilding"].join(","),
            salary: 25000,
    ...
    prisma.user.create({
      data: {
        ...
        trainer: {
          create: {
            experience: 3,
            certifications: ["ISSA Certified", "CrossFit L1"].join(","),
            specialization: ["CrossFit", "Functional Training", "Weight Loss"].join(","),
            salary: 20000,
    ...
    prisma.user.create({
      data: {
        ...
        trainer: {
          create: {
            experience: 4,
            certifications: ["Yoga Alliance RYT-200", "Pilates Certified"].join(","),
            specialization: ["Yoga", "Flexibility", "Rehabilitation"].join(","),
            salary: 22000,
    ...
    prisma.user.create({
      data: {
        ...
        trainer: {
          create: {
            experience: 6,
            certifications: ["NSCA-CSCS", "Sports Performance Coach"].join(","),
            specialization: ["Sports Performance", "Cardio Training", "Nutrition"].join(","),
            salary: 28000,
  ...
  const plans = await Promise.all([
    prisma.membershipPlan.create({
      data: {
        ...
        features: ["Full Gym Access", "Locker Room Access", "Free Fitness Assessment", "Basic Workout Plan"].join(","),
        isActive: true,
      },
    }),
    prisma.membershipPlan.create({
      data: {
        ...
        features: ["Full Gym Access", "Locker Room Access", "Free Fitness Assessment", "Personalized Workout Plan", "Diet Consultation", "1 Personal Training Session"].join(","),
        isActive: true,
      },
    }),
    prisma.membershipPlan.create({
      data: {
        ...
        features: ["Full Gym Access", "Locker Room Access", "Free Fitness Assessment", "Personalized Workout Plan", "Monthly Diet Plan", "3 Personal Training Sessions", "Progress Tracking"].join(","),
        isActive: true,
      },
    }),
    prisma.membershipPlan.create({
      data: {
        ...
        features: ["Full Gym Access", "Locker Room Access", "Free Fitness Assessment", "Personalized Workout Plan", "Weekly Diet Plan", "6 Personal Training Sessions", "Progress Tracking", "Priority Support", "Guest Pass (2/month)"].join(","),
        isActive: true,
      },
    }),
  ]);
  ...
  for (let i = 0; i < members.length; i++) {
    ...
    await prisma.payment.create({
      data: {
        ...
        method: ["CASH", "UPI", "CARD", "RAZORPAY"][i % 4] ,
        status: "COMPLETED",
    ...
    data: [
      {
        ...
        author: "Rahul Singh",
        tags: ["fitness", "beginners", "tips", "workout"].join(","),
        isPublished: true,
      ...
      },
      {
        ...
        author: "Vikash Kumar",
        tags: ["muscle", "bodybuilding", "nutrition", "training"].join(","),
        isPublished: true,
      ...
      },
      {
        ...
        author: "Sneha Gupta",
        tags: ["nutrition", "diet", "health", "myths"].join(","),
        isPublished: true,
