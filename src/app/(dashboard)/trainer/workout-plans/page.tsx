    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400">Design and assign training regimens.</p>
        </div>
        <button 
      ...
      <div className="glass rounded-xl p-6 min-h-[400px]">
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center">
            ...
            <p className="text-slate-400 max-w-sm mb-6">You haven't created any workout plans yet. Start building your first program.</p>
