  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        ...
        <button className="p-2 bg-[slate-800] border border-[slate-700] rounded-full text-white hover:bg-[slate-800]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass rounded-xl p-6 md:col-span-2 relative overflow-hidden group">
          <div className="absolute inset-0 bg-gradient-to-r from-sky-600/20 to-transparent z-0 pointer-events-none"></div>
          <div className="relative z-10">
            <div className="flex justify-between items-start mb-4">
              <div>
                <p className="text-sm text-sky-500 font-bold tracking-wider uppercase">Active Plan</p>
                <h3 className="text-2xl font-bold text-white">Annual Membership</h3>
              </div>
              <span className="bg-sky-500/10 text-sky-500 px-3 py-1 rounded-full text-xs font-medium">
                142 Days Left
              </span>
            </div>
            ...
            <p className="text-xs text-slate-400 mb-6">Expires on Oct 24, 2026</p>
            
            <Link href="/member/membership" className="inline-flex items-center text-sm text-white bg-sky-600 px-4 py-2 rounded-lg hover:bg-sky-700 transition">
        ...
        <div className="glass rounded-xl p-6 flex flex-col items-center justify-center text-center">
          ...
          <p className="text-xs text-slate-400">Scan at reception</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="glass rounded-xl p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-sm text-slate-400">Next Assessment</p>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="glass rounded-xl p-6">
          <div className="flex justify-between items-center mb-6">
            ...
            <Link href="/member/workout" className="text-sky-500 text-sm hover:underline">View All</Link>
          </div>
          <div className="space-y-4">
            <div className="p-4 bg-[slate-800] border border-[slate-700] rounded-lg">
              ...
              <p className="text-sm text-slate-400 mb-3">Focus on progressive overload for bench press.</p>
              <div className="flex flex-wrap gap-2">
                <span className="text-xs px-2 py-1 bg-[slate-800] rounded text-gray-300">Bench Press</span>
                <span className="text-xs px-2 py-1 bg-[slate-800] rounded text-gray-300">Incline DB Press</span>
                <span className="text-xs px-2 py-1 bg-[slate-800] rounded text-gray-300">Lateral Raises</span>
                <span className="text-xs px-2 py-1 bg-[slate-800] rounded text-gray-300">+4 more</span>
              </div>
            </div>
          </div>
        </div>
              ...
              <div key={i} className="flex justify-between items-center p-3 hover:bg-white/5 rounded-lg transition">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-slate-400">{i === 1 ? "Today" : `${i} days ago`}</p>
                  </div>
                </div>
                <div className="text-right">
                  <p className="text-sm text-white">18:30 - 20:00</p>
                  <p className="text-xs text-slate-400">1h 30m</p>
                </div>
              </div>
            ))}
          </div>
