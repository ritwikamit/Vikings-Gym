  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        ...
        <button className="px-4 py-2 bg-sky-600 text-white rounded-lg text-sm font-medium hover:bg-sky-700 transition">
          Edit Profile
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="glass rounded-xl p-6 lg:col-span-2 space-y-8">
          <div className="flex items-center gap-6">
            <div className="w-24 h-24 rounded-full bg-sky-500/20 text-sky-500 flex items-center justify-center text-3xl font-bold border-4 border-[slate-800]">
              AP
            </div>
            <div>
              <h2 className="text-2xl font-bold text-white">Arjun Patel</h2>
              <p className="text-slate-400">arjun@email.com</p>
              <div className="flex gap-2 mt-2">
                <span className="bg-green-500/10 text-green-500 px-2 py-1 rounded text-xs font-medium">Active Member</span>
                <span className="bg-[slate-800] border border-[slate-700] text-gray-300 px-2 py-1 rounded text-xs font-medium">Joined Jan 2026</span>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider mb-4 border-b border-[slate-700] pb-2">Emergency Contact</h3>
              <div className="space-y-4">
                <div className="flex items-center gap-3">
        ...
        <div className="glass rounded-xl p-6 space-y-6">
          <h3 className="text-sm font-semibold text-slate-400 uppercase tracking-wider border-b border-[slate-700] pb-2">Physical Stats</h3>
          ...
          <div className="bg-[slate-800] border border-[slate-700] p-4 rounded-lg">
            <p className="text-xs text-slate-500 mb-1">Fitness Goal</p>
            <p className="text-sm font-medium text-white flex items-center gap-2">
              <Target className="w-4 h-4 text-sky-500" /> Muscle Gain
            </p>
          </div>
        </div>
      </div>
