              ...
              <TiltCard intensity={10} className="h-full">
                <div
                  className={cn(
                    ...
                    plan.popular
                      ? 'bg-gradient-to-b from-[#0EA5E9]/20 to-slate-900 border-[#0EA5E9]/40 scale-[1.05] shadow-[0_20px_60px_-15px_rgba(14,165,233,0.3)] z-10'
                      : 'bg-white/[0.02] border-white/10 hover:border-[#0EA5E9]/30'
                  )}
                >
                  {plan.popular && (
                    <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#0EA5E9] via-[#38BDF8] to-[#0EA5E9]" />
                  )}
                  <div className="p-8 lg:p-10 flex-1 flex flex-col">
                    {plan.popular && (
                      <div className="mb-6">
                        <span className="inline-flex items-center px-4 py-1.5 rounded-full bg-[#0EA5E9] text-white text-[10px] font-bold uppercase tracking-[0.2em] shadow-lg">
                          Recommended
                        </span>
                      </div>
                    )}
                    ...
                    <ul className="space-y-4 mb-10 flex-1">
                      {plan.features.map((feature) => (
                        <li key={feature} className="flex items-start gap-3 text-sm">
                          <div className="mt-1 w-4 h-4 rounded-full bg-[#0EA5E9]/10 flex items-center justify-center shrink-0">
                      ...
                      <Link
                        ...
                        className={cn(
                          ...
                          plan.popular
                            ...
                            : 'bg-white/5 text-white hover:bg-[#0EA5E9] border border-white/10 hover:border-[#0EA5E9]'
                        )}
                      >
