...
export function FreeTrialCTA() {
  return (
    <section className="py-20 lg:py-24 relative overflow-hidden bg-black">
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full h-full max-w-4xl bg-[#0EA5E9]/10 rounded-full blur-[150px] pointer-events-none" />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <Reveal className="text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contact"
              className="group inline-flex items-center gap-3 px-10 py-5 bg-[#0EA5E9] text-white text-sm font-black tracking-widest uppercase rounded-2xl hover:bg-[#A32020] transition-all duration-500 shadow-[0_10px_40px_rgba(198,40,40,0.3)] hover:shadow-[0_15px_50px_rgba(198,40,40,0.5)] hover:-translate-y-1"
            >
              Claim Free Pass
